...
# after_trigram_count = trigram_count.sort_values(ascending=False)
...
# plt.figure()
# word_count.head(20).plot(kind='bar', figsize=(10, 6))
# plt.xticks(rotation=45, ha='right')
...
# plt.figure()
# bigram_count.head(20).plot(kind='bar', figsize=(10, 6))
# plt.xticks(rotation=45, ha='right')
...
# plt.figure()
# trigram_count.head(20).plot(kind='bar', figsize=(10, 6))
# plt.xticks(rotation=45, ha='right')
